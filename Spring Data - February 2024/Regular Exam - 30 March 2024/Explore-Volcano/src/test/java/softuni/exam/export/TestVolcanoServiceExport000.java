...
public class TestVolcanoServiceExport000 {

    @Autowired
    private VolcanoServiceImpl volcanoService;

    @Sql({"/countries-test-imports.sql", "/volcanoes-test-imports.sql", "/volcanologists-test-imports.sql"})
    @Test
